...
/*:
 * @plugindesc v.2.0.1 Allows you to change the text color of items, weapons, armors and skills.
 * @author DKPlugins
 ...
 * @help
 ...
 ## Instructions
 ###=========================================================================
 Use item/weapon/armor/skill notes to indicate color:
 <color: x>
 Replace x with a number value depicting a window text color.
 OR
 <color: #rrggbb>
 Replace rrggbb with any color in hex format.
