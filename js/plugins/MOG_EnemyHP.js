...
/*:
 * @plugindesc (v1.4) Показывает HP врага при атаке.
 * @author Moghunter
 *
 ...
 * ** История изменений **
 * ===========================================================================
 * (v1.4) Улучшена совместимость плагинов.
 * (v1.3) Исправлен сбой, связанный с notetags.
 * (v1.2) Улучшена кодировка.
 * (v1.1) - Улучшена анимация красного индикатора.
 *      - Изменена метка для скрытия HP на HIDE HP.
 *      - Улучшена кодировка.
 */
